...
* Responsive mobile
* Mobile friendly
* Tampilan mobile wajib rapih dan elemen tidak boleh saling menumpuk (no overlapping, proporsional, flex/grid wrap rapih, hindari horizontal overflow yang merusak layout)
...
* Modern clean UI
* Default background putih (`bg-white` / clean white theme) jika tidak ada instruksi warna background khusus
* Jangan terlalu banyak teks tambahan (hindari redundant/unnecessary text clutter, buat teks ringkas, to the point, dan informatif)
* Consistent spacing
* Reusable components
* Responsive table
* Empty state
...
* Membuat code rapih
* Membuat responsive UI yang rapih di mobile tanpa elemen saling menumpuk
* Mengutamakan UI clean dengan default background putih jika tidak ada instruksi warna khusus
* Menjaga teks/copy ringkas, informatif, dan tidak berlebihan (no text clutter)
* Membuat API lengkap
* Membuat SQL file
